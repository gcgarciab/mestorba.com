...
database_name = case Padrino.env
  when :development then 'mestorba_development'
  when :production  then 'mestorba_production'
  when :test        then 'mestorba_test'
end
...
#     sessions:
#       default:
#         database: mestorba_development
#         hosts:
#           - localhost:27017
#   production:
#     sessions:
#       default:
#         database: mestorba_production
#         hosts:
#           - localhost:27017
#   test:
#     sessions:
#       default:
#         database: mestorba_test
#         hosts:
#           - localhost:27017
#
#
